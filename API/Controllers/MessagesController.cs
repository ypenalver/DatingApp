    ...
    IUserRepository userRepository, IMapper mapper): BaseApiController
{
    ...
    public async Task<ActionResult<MessageDto>> CreateMessage(CreateMessageDto createMessageDto)
    {
        ...
        if (recipient == null || sender == null || sender.UserName == null || recipient.UserName == null) return BadRequest("You cannot sent message at this time");
    ...
    public async Task<ActionResult<IEnumerable<MessageDto>>> GetMessagesFor([FromQuery]MessageParams messageParams)
    {
        ...
        var messages = await messageRepository.GetMesageForUser(messageParams);
